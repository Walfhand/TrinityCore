...
DELETE FROM `creature` WHERE `id` = 900005;
DELETE FROM `creature_template` WHERE `entry` = 900005;
DELETE FROM `creature` WHERE `id` = 900006;
DELETE FROM `creature_template` WHERE `entry` = 900006;
DELETE FROM `creature` WHERE `id` = 900007;
DELETE FROM `creature_template` WHERE `entry` = 900007;
DELETE FROM `creature` WHERE `id` = 900008;
...
-- MOBA prototype: caster (ranged) and siege (cannon) lane minions.
INSERT INTO `creature_template` (
    `entry`, `difficulty_entry_1`, `difficulty_entry_2`, `difficulty_entry_3`,
    `KillCredit1`, `KillCredit2`, `modelid1`, `modelid2`, `modelid3`, `modelid4`,
    `name`, `subname`, `IconName`, `gossip_menu_id`, `minlevel`, `maxlevel`, `exp`,
